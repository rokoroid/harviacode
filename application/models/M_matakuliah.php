...
class M_matakuliah extends CI_Model
{
    ...
    function join()
    {
        $this->db->select('tb_makul.id_makul, tb_makul.semester, tb_makul.kode_makul, tb_makul.nama_makul, tb_makul.sks, tb_makul.jenis_makul, tb_makul.angkatan, tb_prodi.nama_prodi');
    ...
    function getMakulGanjil($id)
    {
        $this->db->select('*');
        $query = $this->db->get('v_makul_ganjil');
        return $query->result();
    }

    function getMakulGenap($id)
    {
        $this->db->select('*');
        $query = $this->db->get('v_makul_genap');
        return $query->result();
    }
