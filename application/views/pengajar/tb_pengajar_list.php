<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <h2 style="margin-top:0px">Data Pengajar</h2>

        <div class="col-sm-12"  style="margin-top:20px; margin-bottom:10px;">
            <form id="filter" method="post">
            <div class="form-group col-md-3">
                <label>Fakultas</label>
                <select class="form-control" name="fakultas" id="fakultas_dosen">
            ...
            <div class="form-group col-md-3">
                ...
                <select class="form-control" name="prodi" id="prodi_dosen">
        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <!-- <div class="col-md-12" style="text-align: right;">
                <?php echo anchor(site_url('jadwal/create'),'Tambah Data', 'class="btn btn-primary"'); ?>
            </div> -->
        ...
        <table class="table table-bordered tabledosen" style="margin-bottom: 10px">
           <thead>
            <tr>
                <th>No</th>
